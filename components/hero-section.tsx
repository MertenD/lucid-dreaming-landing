...
export default function HeroSection() {
  return (
      <section className="relative min-h-[100vh] overflow-hidden md:px-16">
        ...
        <div
            className="absolute inset-0 z-0 bg-gradient-to-b from-[#1e1a38]/0 via-[#1e1a38]/10 to-[#1e1a38] md:hidden"></div>
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="flex flex-col justify-center space-y-10">
                <div className="space-y-2">
                  ...
                  <h2 className="text-xl text-[#f5f0d9]/90 lg:text-2xl">Ein praktischer Leitfaden zum luziden
                    Träumen</h2>
                </div>
